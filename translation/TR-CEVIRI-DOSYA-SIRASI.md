# Vue Dokumantasyonu Turkce Ceviri Dosya Sirasi

Bu dokuman, ceviriyi dosya bazinda sirasiyla ilerletmek icin hazirlanmistir.

## Hedef

- Ilk resmi esik: 35 dosya (yaklasik yuzde 30)
- Formul: 35 / 118 = 29.7
- Ilk PR zamani: 35 dosya tamamlandiktan sonra

## Milestone 1: 7 Gun Yogun Plan
...
- [ ] 35 dosya icin terminoloji tutarliligi turu
- [ ] 35 dosya icin dahili link kontrolu
- [ ] pnpm run type
- [ ] pnpm run build
- [ ] pnpm run preview
- [ ] Milestone PR ac (35/118)

## Milestone 1 Sonrasi Sirali Ceviri Plani

### Faz 2: Guide Baslangic ve Components (10 dosya)
...
### Faz 3: Reusability ve Scaling Up (9 dosya)
...
### Faz 8: Diger Kalan Markdown Dosyalari (15 dosya)
...
## Gunluk Takip Onerisi

- Her gun sonunda tamamlanan dosya adedini bu dosyada isaretle.
- Kac dosya kaldi bilgisini Faz bazinda guncel tut.
- Her 8-10 dosyada bir ara QA yap.
